...
const el = <h1 id='greeting'>Hello!</h1>

const container = document.getElementById('root')

Didact.render(el, container)

/**
 * Create root Fiber and assign it as the nextWorkUnit -> asign workloop to requestIdleCallback ↴
 * -> processWork then assign the next work -> after all element is processed tobe fibers, render complete fiber tree
 */